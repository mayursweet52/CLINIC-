    ...
    <div className="pb-20 min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 bg-white border-b border-slate-200 p-4 z-10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="font-bold text-slate-900">{dashboard.name}</h1>
          </div>
        </div>
      ...
      <main className="p-4 space-y-6 max-w-md mx-auto">
        ...
        {dashboard.pendingBills?.length > 0 && (
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">Pending Bills</h2>
            <div className="space-y-2">
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 w-full bg-white border-t border-slate-200 pb-safe z-10 max-w-md left-1/2 -translate-x-1/2 rounded-t-2xl shadow-lg">
