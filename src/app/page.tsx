      ...
      <header className="bg-white border-b border-slate-200 py-4 px-6 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/staff/login" className="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Staff Login</Link>
          </div>
        </div>
      </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {hospitals.map(hospital => (
                ...
                >
                  ...
                  <p className="text-slate-500 text-sm font-medium">{hospital.domain}</p>
                </button>
              ))}
