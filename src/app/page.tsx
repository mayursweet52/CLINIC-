    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 selection:bg-blue-100 selection:text-blue-900">
      <div className="max-w-4xl w-full animate-in zoom-in-95 duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Staff Login */}
          <Link href="/staff/login" className="group bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-purple-300 transition-all flex flex-col items-center text-center">
          ...
          {/* Super Admin */}
          <Link href="/superadmin" className="group bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-sm hover:shadow-2xl transition-all flex flex-col items-center text-center">
